...
$errorNEWS = TRUE;
$erreurMSG = 'formulatire usa para adicionar uma not�cia';
}
else {
...
$sql = 'INSERT INTO live_publicidade VALUES("", "'.mysql_escape_string($_POST['NEWSauteur']).'", "'.mysql_escape_string($_POST['NEWStitre']).'", "'.date("Y-m-d H:i:s").'", "'.mysql_escape_string($_POST['NEWSnews']).'", "'.mysql_escape_string($_POST['icon']).'")';

// on lance la requête (mysql_query) et on impose un message d'erreur si la requête ne se passe pas bien (or die)
mysql_query($sql) or die('Erreur SQL !'.$sql.'<br />'.mysql_error());
$okNEWS = TRUE;
$okMSGNEWS = 'Banner anunciado com sucesso!';
$formulaireNEWS = NULL;
}
}
}
  ...
  if (isset($_GET['del'])) // Si on demande de supprimer une news
{
    ...
    mysql_query('DELETE FROM live_publicidade WHERE id=\'' . $_GET['del'] . '\'');
}
...
// lancement de la requête d'insertion
$sql = "UPDATE live_publicidade SET auteur='" . secu($_POST['NEWSauteur']) . "', titre='" . secu($_POST['NEWStitre']) . "', date='" . date("Y-m-d H:i:s") . "', contenu='" . $_POST['NEWSnews'] . "', icon='" . secu($_POST['icon']) . "' WHERE id='" . $_GET['edit'] . "'";

// on lance la requête (mysql_query) et on impose un message d'erreur si la requête ne se passe pas bien (or die)
mysql_query($sql) or die('Erreur SQL !'.$sql.'<br />'.mysql_error());
$okNEWS = TRUE;
$okMSGNEWS = 'Banner atualizado com sucesso!';
$formulaireNEWS = NULL;
}
}
}
...
<tr><td id="not_title">GER�NCIADOR DE BANNERS</td></tr>
...
<?php if(isset($_GET['edit'])){ echo '<form action="index.php?page=publicidade&amp;edit=' . $_GET['edit'] . '" method="post">'; } elseif(isset($_GET['add'])) { echo '<form action="index.php?page=publicidade&amp;add" method="post">'; } ?>
...
<b style="padding:0px 0px 0px 440px; color:red;"><?php if($errorNEWS == TRUE) { echo '' .  $erreurMSG . ''; } ?></b>
</td>
</tr>
</form>
...
<tr id="not_content">
<b>&nbsp;<a href="index.php?page=publicidade&amp;add" style="color:red;">ADICIONAR NOVO BANNER</a></b>
</tr>
...
<?php
$retour = mysql_query('SELECT * FROM live_publicidade ORDER BY id DESC');
...
<td></td><td></td><td>&nbsp;&nbsp;</td><td></td><td>&nbsp;&nbsp;</td><td></td><td>&nbsp;&nbsp;</td><td></td><td>&nbsp;&nbsp;</td><td></td><td>&nbsp;&nbsp;</td><td></td><td>&nbsp;&nbsp;</td><td></td><td>&nbsp;&nbsp;</td>
<td><a href="index.php?page=publicidade&amp;del=<?php echo '' . $donnees['id'] . ''; ?>" title="Excluir"><img src="imagens/excluir.png"/></a></td>
<td></td><td></td><td>&nbsp;&nbsp;</td><td></td><td>&nbsp;&nbsp;</td><td></td><td>&nbsp;&nbsp;</td><td></td><td>&nbsp;&nbsp;</td><td></td><td>&nbsp;&nbsp;</td><td></td><td>&nbsp;&nbsp;</td><td></td><td>&nbsp;&nbsp;</td>
</tr>
